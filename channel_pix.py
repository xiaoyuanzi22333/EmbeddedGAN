...
def train_pix2pix():
    print("======= start =======")
    train_data = MyDatasets(encode_path, truth_path, transform=transforms.ToTensor(), step=False, add=True)
    ...
    for epoch in range(num_epochs):
        ...
        for edge, label in tqdm(train_loader):
            ...
            if itr % itr_save_img == 0:
                ...
                edge_numpy = (edge.view(batch_size,in_ch,256,256)).data.cpu().numpy()
